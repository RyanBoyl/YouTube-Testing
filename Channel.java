...
public class Channel extends SignIn
{
    ...
    void setup() throws InterruptedException {
        //System.setProperty("webdriver.gecko.driver", "C:\\Users\\hoyen\\Downloads\\Chrome Driver\\chromedriver.exe");
    ...
    {   //Verify that the user can subscribe to the channel from the channel page
        ...
        Thread.sleep(10000);
        //Verify that the user can unsubscribe from the channel from the channel page
    ...
    {   //Verify that the About page can be viewed
    ...
    {   //Verify that the Video page can be clicked on
